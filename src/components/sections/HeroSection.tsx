        ...
        <p className="mb-8 text-xl text-blue-50 md:text-2xl">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 md:grid-cols-4">
            <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
              ...
              <div className="text-sm text-blue-50">Real Estate Team in Alabama</div>
              <div className="mt-1 text-xs text-blue-200">2020 to 2025</div>
            </div>
            <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
              <div className="mb-2 text-3xl font-bold">4000+</div>
              <div className="text-sm text-blue-50">5-star reviews</div>
            </div>
            <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
              <div className="mb-2 text-3xl font-bold">$2+B</div>
              <div className="text-sm text-blue-50">In Real Estate Sales</div>
            </div>
            <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
              <div className="mb-2 text-3xl font-bold">12</div>
              <div className="text-sm text-blue-50">Hours - We sell a home every 12 hours!</div>
            </div>
          </div>
        </div>
      </div>
