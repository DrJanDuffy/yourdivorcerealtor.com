    ...
    <section className="bg-gradient-to-r from-blue-600 to-blue-800 py-20 text-white">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          {/* Primary H1 with target search terms: "Dr. Jan Duffy Divorce Real Estate" and "Divorce Real Estate Agent Las Vegas" */}
          <h1 className="mb-4 text-5xl font-bold md:text-6xl">
            Divorce Real Estate Agent Las Vegas
          </h1>
          <p className="mb-6 text-xl font-medium text-blue-200 md:text-2xl">
            {messaging.headlines.primary} - {messaging.headlines.subtitle}
          </p>
