...
const path = '/how-to-sell-house-during-divorce';
      ...
      >
        <div className="prose prose-lg mx-auto max-w-4xl">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Sell and split proceeds:</strong>
              {' '}
              Clean break, both parties get cash
            </li>
            <li>
            ...
            <li>
              <strong>Co-own temporarily:</strong>
              {' '}
              Keep house for children or market timing
            </li>
            <li>
              <strong>Refinance:</strong>
              {' '}
              Remove one spouse from mortgage
            </li>
          </ul>
          <p className="mt-4">
            Learn more about your options:
            {' '}
            <Link href="/divorce-property-division" className="text-blue-600 underline hover:text-blue-700">Divorce Property Division Options</Link>
          </p>
          ...
          <p className="mt-4">
            ...
            {' '}
            <Link href="/divorce-home-valuation" className="text-blue-600 underline hover:text-blue-700">Home Valuation Services</Link>
          </p>
          ...
          <p className="mt-4">
            Learn more:
            {' '}
            <Link href="/certified-divorce-real-estate-expert" className="text-blue-600 underline hover:text-blue-700">Certified Divorce Real Estate Expert</Link>
          </p>
          ...
          <p className="mt-4">
            Detailed guide:
            {' '}
            <Link href="/divorce-home-staging" className="text-blue-600 underline hover:text-blue-700">Preparing Your Home for Sale During Divorce</Link>
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              {' '}
              30-90 days (Las Vegas market average)
            </li>
            <li>
          ...
          <p className="mt-4">
            Detailed timeline:
            {' '}
            <Link href="/divorce-home-sale-timeline" className="text-blue-600 underline hover:text-blue-700">Divorce Home Sale Timeline</Link>
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Using a non-specialized agent:</strong>
              {' '}
              Traditional agents don't understand divorce dynamics
            </li>
            <li>
              <strong>Overpricing:</strong>
              {' '}
              Leads to extended time on market and lower final price
            </li>
            <li>
              <strong>Poor communication:</strong>
              {' '}
              Both spouses must stay informed
            </li>
            <li>
              <strong>Ignoring court orders:</strong>
              {' '}
              Strict compliance is required
            </li>
            <li>
              <strong>Emotional decisions:</strong>
              {' '}
              Keep focus on financial outcomes
            </li>
            <li>
              <strong>Rushing the process:</strong>
              {' '}
              Allow adequate time for proper preparation
            </li>
          </ul>
          <p className="mt-4">
            Learn more:
            {' '}
            <Link href="/divorce-real-estate-mistakes" className="text-blue-600 underline hover:text-blue-700">Common Divorce Real Estate Mistakes</Link>
          </p>
          ...
          <div className="my-8 border-l-4 border-blue-600 bg-blue-50 p-6">
            <h3 className="mb-2 text-xl font-semibold">Ready to Get Started?</h3>
            <p className="mb-4">
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li><Link href="/divorce-home-sale-timeline" className="text-blue-600 underline hover:text-blue-700">Timeline Guide</Link></li>
            <li><Link href="/divorce-home-sale-checklist" className="text-blue-600 underline hover:text-blue-700">Complete Checklist</Link></li>
          </ul>
        </div>
      </DivorcePageTemplate>
    </>
