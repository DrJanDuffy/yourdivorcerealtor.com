        ...
        <div className="prose prose-lg mx-auto max-w-4xl">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              ...
              {' '}
              Work with a mediator to reach agreement
            </li>
            <li>
              <strong>Court order:</strong>
              {' '}
              Petition court to order the sale
            </li>
            <li>
            ...
            <li>
              <strong>Wait:</strong>
              {' '}
              Delay sale until agreement is reached or court orders it
            </li>
          </ul>
          <p className="mt-4">
            Learn more:
            {' '}
            <Link href="/one-spouse-wont-sell-house-divorce" className="text-blue-600 underline hover:text-blue-700">One Spouse Won't Sell</Link>
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Before divorce (filing jointly):</strong>
              {' '}
            ...
            <li>
              ...
              {' '}
              Each spouse can exclude up to $250,000
            </li>
          </ul>
          <p className="mt-4">
            Learn more:
          ...
          <ol className="list-decimal space-y-2 pl-6">
            <li>
              <strong>Consult with attorney:</strong>
              {' '}
              Understand legal requirements
            </li>
            <li>
              <strong>Get home valuation:</strong>
              {' '}
              Know your home's value for property division
            </li>
            <li>
              <strong>Discuss with spouse:</strong>
              {' '}
              Try to reach agreement
            </li>
            <li>
              <strong>Choose divorce real estate specialist:</strong>
              {' '}
              Work with someone who understands divorce sales
            </li>
            <li>
              <strong>Obtain necessary approvals:</strong>
              {' '}
              Court approval or spouse agreement
            </li>
            <li>
              <strong>List and sell:</strong>
              {' '}
              Proceed with sale according to agreement/order
            </li>
          </ol>
          ...
          <div className="my-8 border-l-4 border-blue-600 bg-blue-50 p-6">
            <h3 className="mb-2 text-xl font-semibold">Ready to Sell Your House During Divorce?</h3>
            <p className="mb-4">
