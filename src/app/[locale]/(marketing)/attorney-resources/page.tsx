    ...
    <>
      ...
      >
        <div className="prose prose-lg mx-auto max-w-4xl">
          ...
          <p>
            If you're a family law attorney working on divorce cases involving real estate, Dr. Jan Duffy is here to help.
            {' '}
            <CalendlyLink className="text-blue-600 hover:text-blue-700">Schedule a consultation</CalendlyLink>
            {' '}
            to learn how her specialized expertise can support your clients and your legal practice.
          </p>
        </div>
      </DivorcePageTemplate>
    </>
